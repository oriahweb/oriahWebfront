          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="post-tag-and-title">
                <h1 className="post-title">Open Fashion - Application Mobile</h1>
          ...
          <div className="details-page-content mb-130">
            ...
            <div className="row g-lg-4 gy-3">
              <div className="col-lg-6">
                <p className="first-para">
                  Open Fashion est une application mobile e-commerce sophistiquée conçue 
                  pour les passionnés de mode. L'application offre une expérience d'achat 
                  fluide axée sur la haute couture, proposant une collection soigneusement 
                  sélectionnée de vêtements, d'accessoires et de produits lifestyle de 
                  marques haut de gamme.
                </p>
              </div>
              <div className="col-lg-6">
                <p>
                  L'application allie design élégant et fonctionnalités puissantes, 
                  offrant aux utilisateurs une interface intuitive pour parcourir les 
                  collections, effectuer des achats et rester informés des dernières 
                  tendances de la mode. L'esthétique minimaliste garantit que les 
                  produits restent au centre de l'attention tout en offrant une 
                  expérience d'achat luxueuse.
                </p>
              </div>
            </div>
            <span className="line-break" />
            ...
            <div className="row g-lg-4 gy-5">
              <div className="col-lg-6">
                ...
                <p>
                  L'application a été développée en mettant l'accent sur l'expérience 
                  utilisateur et la performance, intégrant des pratiques modernes de 
                  développement d'applications mobiles et des fonctionnalités innovantes 
                ...
                <ul>
                  <li>
                    ...
                    Recommandations de produits personnalisées et suggestions de style
                  </li>
                  <li>
                    <svg
                      width={16}
                    ...
                    Recherche avancée et filtrage avec options de taille et de couleur
                  </li>
                  <li>
                    <svg
                      width={16}
                    ...
                    Intégration de paiement sécurisé et suivi des commandes
                  </li>
                  <li>
                    <svg
                      width={16}
                    ...
                    Système de gestion des listes de souhaits et des favoris
                  </li>
                </ul>
              </div>
              <div className="col-lg-6">
            ...
            <div className="row g-4 align-items-center">
              <div className="col-md-12">
                ...
                <p>
                  L'application a été développée avec React Native pour une compatibilité 
                  multiplateforme, assurant une expérience proche du natif sur les 
                  appareils iOS et Android. Nous avons mis en place des mesures de 
                  sécurité de pointe pour le traitement des paiements et la protection 
                  des données utilisateurs.
                </p>
                <br />
                <p>
                  L'optimisation des performances était une priorité, avec la mise en 
                  œuvre d'un chargement d'images efficace, de mécanismes de mise en 
                  cache et d'animations fluides. L'application dispose également de 
                  fonctionnalités hors ligne et de mises à jour en temps réel des stocks.
                </p>
              </div>
            </div>
            <span className="line-break" />
