 ...
 <Sidebar isMenuOpen={isMenuOpen} toggleMenu={toggleMenu} />
    <header className={`header-area style-1 ${style}`}>
      <div className="header-logo">
        <Link href="/"><img alt="image" className="img-fluid dark" src="/assets/img/white-logo.png" /></Link>
        <Link href="/"><img alt="image" className="img-fluid light" src="/assets/img/black-logo.png" /></Link>
      </div>
        ...
        <div className="main-menu">
          ...
          <ul className="menu-list">
            ...
            <li className="menu-item-has-children">
              ...
              <ul className="sub-menu">
                <li><Link href="/about-me">A Propos de l'agence</Link></li>
                <li><Link href="/pricing">Nos tarifs</Link></li>
