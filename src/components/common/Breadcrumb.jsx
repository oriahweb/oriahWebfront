  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage:`linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(/assets/img/innerpage/banner3.jpg)`
                ...
                <div className="col-lg-7 d-flex align-items-end">
                  <div className="dash-and-paragraph">
                    ...
                    <div className="btn-and-paragraph">
                      <p>
                          Offrez une gamme de services pour aider les entreprises
