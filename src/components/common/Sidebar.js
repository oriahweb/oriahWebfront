    ...
    <div className={`sidebar-area ${isMenuOpen ? 'active' : ''}`}>
      <div className="sidebar-menu-top-area">
        <div className="sidebar-menu-logo">
          <Link className="logo-dark" href="/"><img alt="image" className="img-fluid" src="/assets/img/black-logo.png" /></Link>
          <Link className="logo-light" href="/"><img alt="image" className="img-fluid" src="/assets/img/white-logo.png" /></Link>
        </div>
        <div className="nav-right d-flex jsutify-content-end align-items-center">
          <div className="sidebar-menu-close"  onClick={toggleMenu}>
            <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 18 18">
              <path  clipRule="evenodd" d="M18 0L11.1686 8.99601L18 18L9.0041 11.1605L0 18L6.83156 8.99601L0 0L9.0041 6.83156L18 0Z" fill="$b08968">
              </path>
            </svg>
          </div>
            ...
            <div className="sidebar-contact">
                ...
                <ul>
                  <li className="single-contact">
                    ...
                    <div className="contact">
                      <span>Téléphone</span>
                      <h6><a href="tel:+33613476711">+33 6 13 47 67 11</a></h6>
                    </div>
                  </li>
                  <li className="single-contact">
                    <div className="icon">
                    ...
                    <div className="contact">
                      <span>Email</span>
                      <h6><a href="mailto:contact@oriah-consulting.com">contact@oriah-consulting.com</a>
                      </h6>
                    </div>
                  </li>
                  <li className="single-contact">
                    ...
                    <div className="contact">
                      ...
                      <h6><a href="https://www.google.com/maps">Paris, France</a></h6>
                    </div>
                  </li>
                </ul>
              </div>
              <div className="social-link-area">
                ...
                <ul className="social-area">
                  <li><a href="https://www.instagram.com/oriahconsulting/" target="_blank" rel="noopener noreferrer"><i className="bi bi-instagram" /> Instagram</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <ul className="main-menu">
                ...
                <li className={state.activeMenu==="about"?"active":""}>
                  ...
                  <ul className={`submenu-list ${state.activeMenu==="about"?"active":""}`}>
                    <li>
                      <Link href="/about-me">A Propos de l'agence
