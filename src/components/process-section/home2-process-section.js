              ...
              <div className="section-title three text-animation">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p>
                      Nous suivons une approche systématique pour offrir des
                      solutions digitales d'exception. Notre processus éprouvé
                      garantit des résultats de qualité grâce à une
                      planification minutieuse, une exécution rigoureuse et une
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <h3>Recherche & Planification</h3>
                      <p>
                        Nous commençons par comprendre vos objectifs
                        commerciaux, votre audience cible et vos exigences de
                        projet.
                      </p>
                      <ul>
                        <li>
                          <i className="bi bi-plus" /> Analyse du marché
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Recherche de concurrents
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Développement de la
                          stratégie
                        </li>
                      </ul>
                    </div>
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      ...
                      <p>
                        Création de conceptions visuellement attrayantes et
                        fonctionnelles qui correspondent à votre identité de
                        marque.
                      </p>
                      <ul>
                        <li>
                          <i className="bi bi-plus" /> Design UI/UX
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Wireframing
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Prototypes interactifs
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      ...
                      <p>
                        Construction de solutions robustes en utilisant des
                        technologies de pointe et des tests approfondis.
                      </p>
                      <ul>
                        <li>
                          <i className="bi bi-plus" /> Développement
                          personnalisé
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Assurance de la qualité
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Tests de performance
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Tests de sécurité
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      ...
                      <p>
                        Nous assurons un déploiement fluide ainsi qu'une
                        maintenance et un support continus.
                      </p>
                      <ul>
                        <li>
                          <i className="bi bi-plus" /> Déploiement
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Suivi des performances
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Mises à jour régulières
                        </li>
                        <li>
                          <i className="bi bi-plus" /> Support technique
                        </li>
                      </ul>
                    </div>
                  </div>
