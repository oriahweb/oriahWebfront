          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>
                03 ÉTAPES POUR
                <br />
                <span>UN DESIGN PARFAIT.</span>
              </h2>
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  Nous suivons un processus de design éprouvé pour créer des
                  sites web et des expériences numériques qui aident les
                  entreprises à se démarquer et à réussir en ligne.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="row g-lg-4 gy-5">
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                <h3>Découverte</h3>
                <p>
                  Comprenez votre marque, vos objectifs et votre public cible
                  pour créer un plan
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Analyse de marque
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Recherche utilisateur
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Planification de design
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                <h3>Création de design</h3>
                <p>
                  Création de designs beaux et utilisateurs, qui donnent vie à
                  votre vision
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    <i className="bi bi-plus" /> Design visuel
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Prototypage
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Lancer votre design et s'assurer que tout fonctionne
                  parfaitement
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Test de qualité
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Lancement du design
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Support continu
                  </li>
                </ul>
              </div>
            </div>
